---
title: "Git compatibility - Jujutsu docs"
source_url: "https://www.jj-vcs.dev/latest/git-compatibility/index"
...
* Comparisons
  ...
  + Git compatibility
    ...
    Table of contents
    - [Supported features](https://www.jj-vcs.dev/latest/git-compatibility/index.html#supported-features)
    - [Creating an empty repo](https://www.jj-vcs.dev/latest/git-compatibility/index.html#creating-an-empty-repo)
    - [Creating a repo backed by an existing Git repo](https://www.jj-vcs.dev/latest/git-compatibility/index.html#creating-a-repo-backed-by-an-existing-git-repo)
    - [Creating a repo by cloning a Git repo](https://www.jj-vcs.dev/latest/git-compatibility/index.html#creating-a-repo-by-cloning-a-git-repo)
    - [Colocated Jujutsu/Git workspaces](https://www.jj-vcs.dev/latest/git-compatibility/index.html#colocated-jujutsugit-workspaces)

      * [Converting a workspace into a colocated workspace](https://www.jj-vcs.dev/latest/git-compatibility/index.html#converting-a-workspace-into-a-colocated-workspace)
    - [Branches](https://www.jj-vcs.dev/latest/git-compatibility/index.html#branches)
    - [Format mapping details](https://www.jj-vcs.dev/latest/git-compatibility/index.html#format-mapping-details)
...
# Git compatibility[¶](https://www.jj-vcs.dev/latest/git-compatibility/index.html#git-compatibility "Permanent link")
...
## Supported features[¶](https://www.jj-vcs.dev/latest/git-compatibility/index.html#supported-features "Permanent link")
...
[Git-comparison doc](https://www.jj-vcs.dev/latest/git-comparison/index.html).
...
* **Branches: Yes.** You can read more about
  [how branches work in Jujutsu](https://www.jj-vcs.dev/latest/bookmarks/index.html)
  and [how they interoperate with Git](https://www.jj-vcs.dev/latest/git-compatibility/index.html#branches).
...
* **Staging area: Kind of.** The staging area will be ignored. For example,
  ...
  area](https://www.jj-vcs.dev/latest/git-comparison/index.html#the-index).
...
* **Signed commits: Yes.**
  You can sign commits automatically [by configuration](https://www.jj-vcs.dev/latest/config/index.html#commit-signing),
  or use the `jj sign` command.
* **Git LFS: No.** ([#80](https://github.com/jj-vcs/jj/issues/80))

## Creating an empty repo[¶](https://www.jj-vcs.dev/latest/git-compatibility/index.html#creating-an-empty-repo "Permanent link")

To create an empty repo using the Git backend, use `jj git init <name>`. This
creates a [colocated](https://www.jj-vcs.dev/latest/git-compatibility/index.html#colocated-jujutsugit-workspaces) Jujutsu workspace,
there will be a `.jj` directory and a `.git` directory.

## Creating a repo backed by an existing Git repo[¶](https://www.jj-vcs.dev/latest/git-compatibility/index.html#creating-a-repo-backed-by-an-existing-git-repo "Permanent link")
...
## Creating a repo by cloning a Git repo[¶](https://www.jj-vcs.dev/latest/git-compatibility/index.html#creating-a-repo-by-cloning-a-git-repo "Permanent link")
...
## Colocated Jujutsu/Git workspaces[¶](https://www.jj-vcs.dev/latest/git-compatibility/index.html#colocated-jujutsugit-workspaces "Permanent link")
...
* Interleaving `jj` and `git` commands increases the chance of confusing branch
  ...
  ids](https://www.jj-vcs.dev/latest/glossary/index.html#divergent-change). These never lose data, but can be
  annoying.
...
* Colocated workspaces are less resilient to
  [concurrency](https://www.jj-vcs.dev/latest/technical/concurrency/index.html#syncing-with-rsync-nfs-dropbox-etc)
...
### Converting a workspace into a colocated workspace[¶](https://www.jj-vcs.dev/latest/git-compatibility/index.html#converting-a-workspace-into-a-colocated-workspace "Permanent link")
...
## Branches[¶](https://www.jj-vcs.dev/latest/git-compatibility/index.html#branches "Permanent link")

TODO: Describe how branches are mapped

## Format mapping details[¶](https://www.jj-vcs.dev/latest/git-compatibility/index.html#format-mapping-details "Permanent link")
