---
title: "Tutorial and bird's eye view - Jujutsu docs"
source_url: "https://www.jj-vcs.dev/latest/tutorial/index"
...
* Getting started
  ...
  + Tutorial and bird's eye view
    ...
    Table of contents
    - [Preparation](https://www.jj-vcs.dev/latest/tutorial/index.html#preparation)
    - [Cloning a Git repository](https://www.jj-vcs.dev/latest/tutorial/index.html#cloning-a-git-repository)
    - [Changes](https://www.jj-vcs.dev/latest/tutorial/index.html#changes)
    - [Creating our first change](https://www.jj-vcs.dev/latest/tutorial/index.html#creating-our-first-change)
    - [The log command and "revsets"](https://www.jj-vcs.dev/latest/tutorial/index.html#the-log-command-and-revsets)
    - [Conflicts](https://www.jj-vcs.dev/latest/tutorial/index.html#conflicts)
    - [The operation log](https://www.jj-vcs.dev/latest/tutorial/index.html#the-operation-log)
    - [Moving content changes between commits](https://www.jj-vcs.dev/latest/tutorial/index.html#moving-content-changes-between-commits)
...
# Tutorial[¶](https://www.jj-vcs.dev/latest/tutorial/index.html#tutorial "Permanent link")
...
## Preparation[¶](https://www.jj-vcs.dev/latest/tutorial/index.html#preparation "Permanent link")

If you haven't already, make sure you
[install and configure Jujutsu](https://www.jj-vcs.dev/latest/install-and-setup/index.html).

## Cloning a Git repository[¶](https://www.jj-vcs.dev/latest/tutorial/index.html#cloning-a-git-repository "Permanent link")
...
## Changes[¶](https://www.jj-vcs.dev/latest/tutorial/index.html#changes "Permanent link")
...
## Creating our first change[¶](https://www.jj-vcs.dev/latest/tutorial/index.html#creating-our-first-change "Permanent link")
...
## The log command and "revsets"[¶](https://www.jj-vcs.dev/latest/tutorial/index.html#the-log-command-and-revsets "Permanent link")
...
of revisions to list. The flag accepts a ["revset"](https://www.jj-vcs.dev/latest/revsets/index.html), which is an
...
[the revset documentation](https://www.jj-vcs.dev/latest/revsets/index.html) for all revset operators and functions.
...
## Conflicts[¶](https://www.jj-vcs.dev/latest/tutorial/index.html#conflicts "Permanent link")
...
## The operation log[¶](https://www.jj-vcs.dev/latest/tutorial/index.html#the-operation-log "Permanent link")
...
## Moving content changes between commits[¶](https://www.jj-vcs.dev/latest/tutorial/index.html#moving-content-changes-between-commits "Permanent link")
...
That will bring up the built-in diff editor[1](https://www.jj-vcs.dev/latest/tutorial/index.html#fn:alternative_diff_editors) with a
...
1. There are many other diff editors you could use.
   ...
   [`ui.diff-editor` option](https://www.jj-vcs.dev/latest/config/index.html#editing-diffs); those docs also explain how
   to specify a path to an executable if it is not in the PATH. [↩](https://www.jj-vcs.dev/latest/tutorial/index.html#fnref:alternative_diff_editors "Jump back to footnote 1 in the text")
