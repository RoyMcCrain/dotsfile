---
title: "Bookmarks - Jujutsu docs"
source_url: "https://www.jj-vcs.dev/latest/bookmarks/index"
...
* Concepts
  ...
  + Bookmarks
    ...
    Table of contents
    - [Introduction](https://www.jj-vcs.dev/latest/bookmarks/index.html#introduction)
    - [Mapping to Git branches](https://www.jj-vcs.dev/latest/bookmarks/index.html#mapping-to-git-branches)
    - [Remotes and tracked bookmarks](https://www.jj-vcs.dev/latest/bookmarks/index.html#remotes-and-tracked-bookmarks)

      * [Terminology summary](https://www.jj-vcs.dev/latest/bookmarks/index.html#terminology-summary)
      * [Manually tracking a bookmark](https://www.jj-vcs.dev/latest/bookmarks/index.html#manually-tracking-a-bookmark)
      * [Untracking a bookmark](https://www.jj-vcs.dev/latest/bookmarks/index.html#untracking-a-bookmark)
      * [Listing tracked bookmarks](https://www.jj-vcs.dev/latest/bookmarks/index.html#listing-tracked-bookmarks)
      * [Automatic tracking of bookmarks & auto-track-bookmarks option](https://www.jj-vcs.dev/latest/bookmarks/index.html#automatic-tracking-of-bookmarks-auto-track-bookmarks-option)
    - [Bookmark updates](https://www.jj-vcs.dev/latest/bookmarks/index.html#bookmark-updates)
    - [Pushing bookmarks: Safety checks](https://www.jj-vcs.dev/latest/bookmarks/index.html#pushing-bookmarks-safety-checks)
    - [Conflicts](https://www.jj-vcs.dev/latest/bookmarks/index.html#conflicts)
    - [Ease of use](https://www.jj-vcs.dev/latest/bookmarks/index.html#ease-of-use)
...
# Bookmarks[¶](https://www.jj-vcs.dev/latest/bookmarks/index.html#bookmarks "Permanent link")

## Introduction[¶](https://www.jj-vcs.dev/latest/bookmarks/index.html#introduction "Permanent link")
...
## Mapping to Git branches[¶](https://www.jj-vcs.dev/latest/bookmarks/index.html#mapping-to-git-branches "Permanent link")
...
[colocated workspaces](https://www.jj-vcs.dev/latest/git-compatibility/index.html#colocated-jujutsugit-repos)).

## Remotes and tracked bookmarks[¶](https://www.jj-vcs.dev/latest/bookmarks/index.html#remotes-and-tracked-bookmarks "Permanent link")
...
bookmark will become conflicted (see the ["Conflicts" section](https://www.jj-vcs.dev/latest/bookmarks/index.html#conflicts) below
for details).
...
[Design Doc](https://www.jj-vcs.dev/latest/design/tracking-branches/index.html).

### Terminology summary[¶](https://www.jj-vcs.dev/latest/bookmarks/index.html#terminology-summary "Permanent link")
...
* A **tracked (remote) bookmark** is defined above. You can make a remote bookmark
  tracked with the [`jj bookmark track` command](https://www.jj-vcs.dev/latest/bookmarks/index.html#manually-tracking-a-bookmark), for
  example.
...
### Manually tracking a bookmark[¶](https://www.jj-vcs.dev/latest/bookmarks/index.html#manually-tracking-a-bookmark "Permanent link")
...
### Untracking a bookmark[¶](https://www.jj-vcs.dev/latest/bookmarks/index.html#untracking-a-bookmark "Permanent link")
...
### Listing tracked bookmarks[¶](https://www.jj-vcs.dev/latest/bookmarks/index.html#listing-tracked-bookmarks "Permanent link")
...
### Automatic tracking of bookmarks & `auto-track-bookmarks` option[¶](https://www.jj-vcs.dev/latest/bookmarks/index.html#automatic-tracking-of-bookmarks-auto-track-bookmarks-option "Permanent link")
...
bookmarks"](https://www.jj-vcs.dev/latest/config/index.html#automatic-tracking-of-bookmarks) for details.

## Bookmark updates[¶](https://www.jj-vcs.dev/latest/bookmarks/index.html#bookmark-updates "Permanent link")
...
## Pushing bookmarks: Safety checks[¶](https://www.jj-vcs.dev/latest/bookmarks/index.html#pushing-bookmarks-safety-checks "Permanent link")
...
2. The local bookmark must not be [conflicted](https://www.jj-vcs.dev/latest/bookmarks/index.html#conflicts). If it is, you would
   ...
   in the background (this situation is a known issue[1](https://www.jj-vcs.dev/latest/bookmarks/index.html#fn:known-issue) with some
...
3. If the remote bookmark already exists on the remote, it must be
   [tracked](https://www.jj-vcs.dev/latest/bookmarks/index.html#remotes-and-tracked-bookmarks).

## Conflicts[¶](https://www.jj-vcs.dev/latest/bookmarks/index.html#conflicts "Permanent link")
...
## Ease of use[¶](https://www.jj-vcs.dev/latest/bookmarks/index.html#ease-of-use "Permanent link")
...
1. See "A general note on safety" in
   <https://git-scm.com/docs/git-push#Documentation/git-push.txt---no-force-with-lease> [↩](https://www.jj-vcs.dev/latest/bookmarks/index.html#fnref:known-issue "Jump back to footnote 1 in the text")
