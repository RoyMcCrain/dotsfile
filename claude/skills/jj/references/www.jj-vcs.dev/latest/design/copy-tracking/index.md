---
title: "Copy tracking and tracing - Jujutsu docs"
source_url: "https://www.jj-vcs.dev/latest/design/copy-tracking/index"
...
* Design docs
  ...
  + Copy tracking and tracing
    ...
    Table of contents
    - [Objective](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#objective)

      * [Desired UX](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#desired-ux)

        + [Restoring from a commit should preserve copies](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#restoring-from-a-commit-should-preserve-copies)
        + [Diff after restore](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#diff-after-restore)
        + [Lossless round-trip of rebase](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#lossless-round-trip-of-rebase)
        + [Reverting the parent commit should be a no-op](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#reverting-the-parent-commit-should-be-a-no-op)
        + [Parallelize/serialize](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#parallelizeserialize)
        + [Copies inside merge commit](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#copies-inside-merge-commit)
        + [Copies across merge commit](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#copies-across-merge-commit)
    - [High-level Design](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#high-level-design)

      * [Diffing](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#diffing)

        + [Example: Divergent copy and rename](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-divergent-copy-and-rename)
        + [Example: Divergent copy and rename (best rename target)](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-divergent-copy-and-rename-best-rename-target)
        + [Example: Copy onto deleted file](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-copy-onto-deleted-file)
      * [Merging](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#merging)

        + [Propagating changes across copies?](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#propagating-changes-across-copies)
        + [Example: Propagate changes to copied file, then rebase back](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-propagate-changes-to-copied-file-then-rebase-back)
        + [Example: Multiple copies](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-multiple-copies)
        + [Example: Convergent renames](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-convergent-renames)
        + [Example: Rebasing](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-rebasing)
        + [Example: Rename added file](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-rename-added-file)
        + [Example: Divergent renames](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-divergent-renames)
        + [Example: @jonathantanmy's test case:](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-jonathantanmys-test-case)
      * [Log](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#log)
      * [Annotate](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#annotate)
      * [Representation in Git](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#representation-in-git)
      * [Representation in cloud repo (e.g. Google)](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#representation-in-cloud-repo-eg-google)
    - [Implementation plan](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#implementation-plan)
    - [Alternatives considered](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#alternatives-considered)

      * [Detect copies (like Git)](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#detect-copies-like-git)
      * [Record logical file identifiers in trees (BitKeeper-like model)](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#record-logical-file-identifiers-in-trees-bitkeeper-like-model)
      * [Include copy info in the FileId (Mercurial-like model)](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#include-copy-info-in-the-fileid-mercurial-like-model)
      * [Hybrid snapshot/patch model with copy info stored in commits](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#hybrid-snapshotpatch-model-with-copy-info-stored-in-commits)
...
# Copy Tracking and Tracing Design[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#copy-tracking-and-tracing-design "Permanent link")
...
## Objective[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#objective "Permanent link")
...
### Desired UX[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#desired-ux "Permanent link")
...
#### Restoring from a commit should preserve copies[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#restoring-from-a-commit-should-preserve-copies "Permanent link")
...
#### Diff after restore[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#diff-after-restore "Permanent link")
...
#### Lossless round-trip of rebase[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#lossless-round-trip-of-rebase "Permanent link")

Except for the [`A+(A-B)=A` rule](https://github.com/martinvonz/jj/blob/560d66ecee5a9904b42dbc0b89333f0c27c683de/lib/src/merge.rs#L98-L111), rebasing is currently never
...
#### Reverting the parent commit should be a no-op[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#reverting-the-parent-commit-should-be-a-no-op "Permanent link")
...
#### Parallelize/serialize[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#parallelizeserialize "Permanent link")
...
#### Copies inside merge commit[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#copies-inside-merge-commit "Permanent link")
...
#### Copies across merge commit[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#copies-across-merge-commit "Permanent link")
...
## High-level Design[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#high-level-design "Permanent link")
...
information into that snapshot-based model too [1](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#fn:martinvonz_slow).
...
### Diffing[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#diffing "Permanent link")
...
#### Example: Divergent copy and rename[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-divergent-copy-and-rename "Permanent link")
...
#### Example: Divergent copy and rename (best rename target)[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-divergent-copy-and-rename-best-rename-target "Permanent link")
...
#### Example: Copy onto deleted file[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-copy-onto-deleted-file "Permanent link")
...
### Merging[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#merging "Permanent link")
...
#### Propagating changes across copies?[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#propagating-changes-across-copies "Permanent link")
...
#### Example: Propagate changes to copied file, then rebase back[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-propagate-changes-to-copied-file-then-rebase-back "Permanent link")
...
#### Example: Multiple copies[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-multiple-copies "Permanent link")
...
#### Example: Convergent renames[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-convergent-renames "Permanent link")
...
#### Example: Rebasing[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-rebasing "Permanent link")
...
#### Example: Rename added file[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-rename-added-file "Permanent link")
...
#### Example: Divergent renames[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-divergent-renames "Permanent link")
...
#### Example: @jonathantanmy's test case:[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#example-jonathantanmys-test-case "Permanent link")
...
### Log[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#log "Permanent link")
...
### Annotate[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#annotate "Permanent link")

TBD

### Representation in Git[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#representation-in-git "Permanent link")
...
### Representation in cloud repo (e.g. Google)[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#representation-in-cloud-repo-eg-google "Permanent link")
...
## Implementation plan[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#implementation-plan "Permanent link")
...
## Alternatives considered[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#alternatives-considered "Permanent link")

### Detect copies (like Git)[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#detect-copies-like-git "Permanent link")
...
### Record logical file identifiers in trees (BitKeeper-like model)[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#record-logical-file-identifiers-in-trees-bitkeeper-like-model "Permanent link")
...
### Include copy info in the FileId (Mercurial-like model)[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#include-copy-info-in-the-fileid-mercurial-like-model "Permanent link")

Mercurial stores copy info in a metadata section in the file content itself
[2](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#fn:mercurial_changeset_copies). That means that a file will get a new file
...
### Hybrid snapshot/patch model with copy info stored in commits[¶](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#hybrid-snapshotpatch-model-with-copy-info-stored-in-commits "Permanent link")
...
1. This took me (@martinvonz) months to really understand. [↩](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#fnref:martinvonz_slow "Jump back to footnote 1 in the text")
2. From around
   ...
   snapshot/patch model we described above as not working well. [↩](https://www.jj-vcs.dev/latest/design/copy-tracking/index.html#fnref:mercurial_changeset_copies "Jump back to footnote 2 in the text")
