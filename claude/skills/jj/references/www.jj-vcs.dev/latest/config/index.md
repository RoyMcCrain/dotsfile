---
title: "Settings - Jujutsu docs"
source_url: "https://www.jj-vcs.dev/latest/config/index"
...
* Reference
  ...
  + Settings
    ...
    Table of contents
    - [Config files and TOML](https://www.jj-vcs.dev/latest/config/index.html#config-files-and-toml)

      * [Dotted style and headings](https://www.jj-vcs.dev/latest/config/index.html#dotted-style-and-headings)
    - [User settings](https://www.jj-vcs.dev/latest/config/index.html#user-settings)
    - [UI settings](https://www.jj-vcs.dev/latest/config/index.html#ui-settings)

      * [Colorizing output](https://www.jj-vcs.dev/latest/config/index.html#colorizing-output)
      * [Custom colors and styles](https://www.jj-vcs.dev/latest/config/index.html#custom-colors-and-styles)
      * [Default command](https://www.jj-vcs.dev/latest/config/index.html#default-command)
      * [Default description](https://www.jj-vcs.dev/latest/config/index.html#default-description)
      * [Duplicate commit description](https://www.jj-vcs.dev/latest/config/index.html#duplicate-commit-description)
      * [Bookmark/tag listing order](https://www.jj-vcs.dev/latest/config/index.html#bookmarktag-listing-order)
      * [Commit trailers](https://www.jj-vcs.dev/latest/config/index.html#commit-trailers)
      * [Diff colors and styles](https://www.jj-vcs.dev/latest/config/index.html#diff-colors-and-styles)
      * [Diff format](https://www.jj-vcs.dev/latest/config/index.html#diff-format)

        + [Color-words diff options](https://www.jj-vcs.dev/latest/config/index.html#color-words-diff-options)
        + [Git diff options](https://www.jj-vcs.dev/latest/config/index.html#git-diff-options)
      * [Generating diffs by external command](https://www.jj-vcs.dev/latest/config/index.html#generating-diffs-by-external-command)
      * [Conflict marker style](https://www.jj-vcs.dev/latest/config/index.html#conflict-marker-style)
      * [Set of immutable commits](https://www.jj-vcs.dev/latest/config/index.html#set-of-immutable-commits)
      * [Behavior of prev and next commands](https://www.jj-vcs.dev/latest/config/index.html#behavior-of-prev-and-next-commands)
    - [List](https://www.jj-vcs.dev/latest/config/index.html#list)

      * [Default Template](https://www.jj-vcs.dev/latest/config/index.html#default-template)
    - [Log](https://www.jj-vcs.dev/latest/config/index.html#log)

      * [Default revisions](https://www.jj-vcs.dev/latest/config/index.html#default-revisions)
      * [Prioritize Revsets in the Log over @](https://www.jj-vcs.dev/latest/config/index.html#prioritize-revsets-in-the-log-over)
      * [Default Template](https://www.jj-vcs.dev/latest/config/index.html#default-template_1)
      * [Graph style](https://www.jj-vcs.dev/latest/config/index.html#graph-style)

        + [Node style](https://www.jj-vcs.dev/latest/config/index.html#node-style)
      * [Wrap log content](https://www.jj-vcs.dev/latest/config/index.html#wrap-log-content)
      * [Display of commit and change ids](https://www.jj-vcs.dev/latest/config/index.html#display-of-commit-and-change-ids)
      * [Relative timestamps](https://www.jj-vcs.dev/latest/config/index.html#relative-timestamps)
      * [Author format](https://www.jj-vcs.dev/latest/config/index.html#author-format)
      * [Commit timestamp](https://www.jj-vcs.dev/latest/config/index.html#commit-timestamp)
      * [Signature format](https://www.jj-vcs.dev/latest/config/index.html#signature-format)
    - [Pager](https://www.jj-vcs.dev/latest/config/index.html#pager)

      * [Builtin pager](https://www.jj-vcs.dev/latest/config/index.html#builtin-pager)

        + [Key bindings](https://www.jj-vcs.dev/latest/config/index.html#key-bindings)
        + [Wrapping config](https://www.jj-vcs.dev/latest/config/index.html#wrapping-config)
        + [Auto-exit, clearing the screen on startup or exit](https://www.jj-vcs.dev/latest/config/index.html#auto-exit-clearing-the-screen-on-startup-or-exit)
        + [Showing the ruler on startup](https://www.jj-vcs.dev/latest/config/index.html#showing-the-ruler-on-startup)
      * [Processing contents to be paged](https://www.jj-vcs.dev/latest/config/index.html#processing-contents-to-be-paged)
    - [Aliases](https://www.jj-vcs.dev/latest/config/index.html#aliases)
    - [Editor](https://www.jj-vcs.dev/latest/config/index.html#editor)
    - [Editing diffs](https://www.jj-vcs.dev/latest/config/index.html#editing-diffs)

      * [Experimental 3-pane diff editing](https://www.jj-vcs.dev/latest/config/index.html#experimental-3-pane-diff-editing)
      * [JJ-INSTRUCTIONS](https://www.jj-vcs.dev/latest/config/index.html#jj-instructions)
      * [Using Meld as a diff editor](https://www.jj-vcs.dev/latest/config/index.html#using-meld-as-a-diff-editor)
      * [Using Vim as a diff editor](https://www.jj-vcs.dev/latest/config/index.html#using-vim-as-a-diff-editor)
    - [3-way merge tools for conflict resolution](https://www.jj-vcs.dev/latest/config/index.html#3-way-merge-tools-for-conflict-resolution)

      * [Setting up a custom merge tool](https://www.jj-vcs.dev/latest/config/index.html#setting-up-a-custom-merge-tool)
      * [Editing conflict markers with a tool or a text editor](https://www.jj-vcs.dev/latest/config/index.html#editing-conflict-markers-with-a-tool-or-a-text-editor)
    - [Code formatting and other file content transformations](https://www.jj-vcs.dev/latest/config/index.html#code-formatting-and-other-file-content-transformations)

      * [Configuration](https://www.jj-vcs.dev/latest/config/index.html#configuration_1)
      * [Enforce coding style rules](https://www.jj-vcs.dev/latest/config/index.html#enforce-coding-style-rules)
      * [Sort and remove duplicate lines from a file](https://www.jj-vcs.dev/latest/config/index.html#sort-and-remove-duplicate-lines-from-a-file)
      * [Tools stored inside the workspace](https://www.jj-vcs.dev/latest/config/index.html#tools-stored-inside-the-workspace)
      * [Execution order of tools](https://www.jj-vcs.dev/latest/config/index.html#execution-order-of-tools)
      * [Disabling and enabling tools](https://www.jj-vcs.dev/latest/config/index.html#disabling-and-enabling-tools)
    - [Commit Signing](https://www.jj-vcs.dev/latest/config/index.html#commit-signing)

      * [GnuPG Signing](https://www.jj-vcs.dev/latest/config/index.html#gnupg-signing)

        + [PKCS#12 Certificates](https://www.jj-vcs.dev/latest/config/index.html#pkcs12-certificates)
      * [SSH Signing](https://www.jj-vcs.dev/latest/config/index.html#ssh-signing)
      * [Manually signing commits](https://www.jj-vcs.dev/latest/config/index.html#manually-signing-commits)
      * [Automatically signing commits](https://www.jj-vcs.dev/latest/config/index.html#automatically-signing-commits)
    - [Commit Signature Verification](https://www.jj-vcs.dev/latest/config/index.html#commit-signature-verification)
    - [Git settings](https://www.jj-vcs.dev/latest/config/index.html#git-settings)

      * [Default colocation](https://www.jj-vcs.dev/latest/config/index.html#default-colocation)
      * [Default remotes for jj git fetch and jj git push](https://www.jj-vcs.dev/latest/config/index.html#default-remotes-for-jj-git-fetch-and-jj-git-push)
      * [Automatic tracking of bookmarks](https://www.jj-vcs.dev/latest/config/index.html#automatic-tracking-of-bookmarks)
      * [Automatic local bookmark creation on jj git clone](https://www.jj-vcs.dev/latest/config/index.html#automatic-local-bookmark-creation-on-jj-git-clone)
      * [Abandon commits that became unreachable in Git](https://www.jj-vcs.dev/latest/config/index.html#abandon-commits-that-became-unreachable-in-git)
      * [Generated bookmark names on push](https://www.jj-vcs.dev/latest/config/index.html#generated-bookmark-names-on-push)
      * [Set of private commits](https://www.jj-vcs.dev/latest/config/index.html#set-of-private-commits)
      * [Git subprocessing behavior](https://www.jj-vcs.dev/latest/config/index.html#git-subprocessing-behavior)
    - [Merge settings](https://www.jj-vcs.dev/latest/config/index.html#merge-settings)

      * [Granularity of hunks](https://www.jj-vcs.dev/latest/config/index.html#granularity-of-hunks)
      * [Resolution of same-change conflicts](https://www.jj-vcs.dev/latest/config/index.html#resolution-of-same-change-conflicts)
    - [Filesystem monitor](https://www.jj-vcs.dev/latest/config/index.html#filesystem-monitor)

      * [Watchman](https://www.jj-vcs.dev/latest/config/index.html#watchman)
    - [Snapshot settings](https://www.jj-vcs.dev/latest/config/index.html#snapshot-settings)

      * [Paths to automatically track](https://www.jj-vcs.dev/latest/config/index.html#paths-to-automatically-track)
      * [Maximum size for new files](https://www.jj-vcs.dev/latest/config/index.html#maximum-size-for-new-files)
      * [Automatic update of stale working copies](https://www.jj-vcs.dev/latest/config/index.html#automatic-update-of-stale-working-copies)
    - [Working copy settings](https://www.jj-vcs.dev/latest/config/index.html#working-copy-settings)

      * [EOL conversion settings](https://www.jj-vcs.dev/latest/config/index.html#eol-conversion-settings)
      * [Respect or ignore executable bit permission changes](https://www.jj-vcs.dev/latest/config/index.html#respect-or-ignore-executable-bit-permission-changes)
    - [Ways to specify jj config: details](https://www.jj-vcs.dev/latest/config/index.html#ways-to-specify-jj-config-details)

      * [User config files](https://www.jj-vcs.dev/latest/config/index.html#user-config-files)
      * [JSON Schema Support](https://www.jj-vcs.dev/latest/config/index.html#json-schema-support)
      * [Specifying config on the command-line](https://www.jj-vcs.dev/latest/config/index.html#specifying-config-on-the-command-line)
      * [Conditional variables](https://www.jj-vcs.dev/latest/config/index.html#conditional-variables)

        + [Using [[--scope]] tables](index.html#using-scope-tables)
        + [Using multiple files](https://www.jj-vcs.dev/latest/config/index.html#using-multiple-files)
        + [Available condition keys](https://www.jj-vcs.dev/latest/config/index.html#available-condition-keys)
...
# Configuration[¶](https://www.jj-vcs.dev/latest/config/index.html#configuration "Permanent link")

These are the config settings available to jj/Jujutsu.

## Config files and TOML[¶](https://www.jj-vcs.dev/latest/config/index.html#config-files-and-toml "Permanent link")
...
* The user settings. These can be edited with `jj config edit --user`. User
  settings are located in [the user config files](https://www.jj-vcs.dev/latest/config/index.html#user-config-files), which can be found with `jj
  config path --user`.
...
* Settings [specified in the command-line](https://www.jj-vcs.dev/latest/config/index.html#specifying-config-on-the-command-line).
...
Support](https://www.jj-vcs.dev/latest/config/index.html#json-schema-support) for details.

See the [TOML site](https://toml.io/en/) and the [syntax guide](https://toml.io/en/v1.0.0) for a detailed description of the
...
### Dotted style and headings[¶](https://www.jj-vcs.dev/latest/config/index.html#dotted-style-and-headings "Permanent link")
...
That's probably enough TOML to keep you out of trouble but the [syntax guide](https://toml.io/en/v1.0.0) is
very short if you ever need to check.

## User settings[¶](https://www.jj-vcs.dev/latest/config/index.html#user-settings "Permanent link")
...
## UI settings[¶](https://www.jj-vcs.dev/latest/config/index.html#ui-settings "Permanent link")

### Colorizing output[¶](https://www.jj-vcs.dev/latest/config/index.html#colorizing-output "Permanent link")
...
### Custom colors and styles[¶](https://www.jj-vcs.dev/latest/config/index.html#custom-colors-and-styles "Permanent link")
...
`jj` also supports colors from the [ANSI 256-color palette](https://en.wikipedia.org/wiki/ANSI_escape_code#8-bit) as `ansi-color-<N>`,
...
### Default command[¶](https://www.jj-vcs.dev/latest/config/index.html#default-command "Permanent link")
...
### Default description[¶](https://www.jj-vcs.dev/latest/config/index.html#default-description "Permanent link")

The editor content of a commit description can be populated by the
`draft_commit_description` template. `self` is a [`Commit`
object](https://www.jj-vcs.dev/latest/templates/index.html#commit-type).
...
### Duplicate commit description[¶](https://www.jj-vcs.dev/latest/config/index.html#duplicate-commit-description "Permanent link")
...
template, which is given a [`Commit` object](https://www.jj-vcs.dev/latest/templates/index.html#commit-type) of the
original commit.
...
### Bookmark/tag listing order[¶](https://www.jj-vcs.dev/latest/config/index.html#bookmarktag-listing-order "Permanent link")
...
### Commit trailers[¶](https://www.jj-vcs.dev/latest/config/index.html#commit-trailers "Permanent link")
...
### Diff colors and styles[¶](https://www.jj-vcs.dev/latest/config/index.html#diff-colors-and-styles "Permanent link")
...
### Diff format[¶](https://www.jj-vcs.dev/latest/config/index.html#diff-format "Permanent link")
...
#### Color-words diff options[¶](https://www.jj-vcs.dev/latest/config/index.html#color-words-diff-options "Permanent link")
...
#### Git diff options[¶](https://www.jj-vcs.dev/latest/config/index.html#git-diff-options "Permanent link")
...
### Generating diffs by external command[¶](https://www.jj-vcs.dev/latest/config/index.html#generating-diffs-by-external-command "Permanent link")
...
### Conflict marker style[¶](https://www.jj-vcs.dev/latest/config/index.html#conflict-marker-style "Permanent link")
...
page](https://www.jj-vcs.dev/latest/conflicts/index.html#conflict-markers).

### Set of immutable commits[¶](https://www.jj-vcs.dev/latest/config/index.html#set-of-immutable-commits "Permanent link")
...
### Behavior of prev and next commands[¶](https://www.jj-vcs.dev/latest/config/index.html#behavior-of-prev-and-next-commands "Permanent link")
...
## List[¶](https://www.jj-vcs.dev/latest/config/index.html#list "Permanent link")

### Default Template[¶](https://www.jj-vcs.dev/latest/config/index.html#default-template "Permanent link")
...
## Log[¶](https://www.jj-vcs.dev/latest/config/index.html#log "Permanent link")

### Default revisions[¶](https://www.jj-vcs.dev/latest/config/index.html#default-revisions "Permanent link")
...
### Prioritize Revsets in the Log over @[¶](https://www.jj-vcs.dev/latest/config/index.html#prioritize-revsets-in-the-log-over "Permanent link")
...
### Default Template[¶](https://www.jj-vcs.dev/latest/config/index.html#default-template_1 "Permanent link")
...
### Graph style[¶](https://www.jj-vcs.dev/latest/config/index.html#graph-style "Permanent link")
...
#### Node style[¶](https://www.jj-vcs.dev/latest/config/index.html#node-style "Permanent link")
...
### Wrap log content[¶](https://www.jj-vcs.dev/latest/config/index.html#wrap-log-content "Permanent link")
...
### Display of commit and change ids[¶](https://www.jj-vcs.dev/latest/config/index.html#display-of-commit-and-change-ids "Permanent link")
...
### Relative timestamps[¶](https://www.jj-vcs.dev/latest/config/index.html#relative-timestamps "Permanent link")
...
### Author format[¶](https://www.jj-vcs.dev/latest/config/index.html#author-format "Permanent link")
...
### Commit timestamp[¶](https://www.jj-vcs.dev/latest/config/index.html#commit-timestamp "Permanent link")
...
### Signature format[¶](https://www.jj-vcs.dev/latest/config/index.html#signature-format "Permanent link")
...
## Pager[¶](https://www.jj-vcs.dev/latest/config/index.html#pager "Permanent link")
...
[the pager](https://www.jj-vcs.dev/latest/config/index.html#builtin-pager) that is built-in to jj).
...
### Builtin pager[¶](https://www.jj-vcs.dev/latest/config/index.html#builtin-pager "Permanent link")
...
#### Key bindings[¶](https://www.jj-vcs.dev/latest/config/index.html#key-bindings "Permanent link")
...
#### Wrapping config[¶](https://www.jj-vcs.dev/latest/config/index.html#wrapping-config "Permanent link")
...
#### Auto-exit, clearing the screen on startup or exit[¶](https://www.jj-vcs.dev/latest/config/index.html#auto-exit-clearing-the-screen-on-startup-or-exit "Permanent link")
...
#### Showing the ruler on startup[¶](https://www.jj-vcs.dev/latest/config/index.html#showing-the-ruler-on-startup "Permanent link")
...
### Processing contents to be paged[¶](https://www.jj-vcs.dev/latest/config/index.html#processing-contents-to-be-paged "Permanent link")
...
## Aliases[¶](https://www.jj-vcs.dev/latest/config/index.html#aliases "Permanent link")
...
## Editor[¶](https://www.jj-vcs.dev/latest/config/index.html#editor "Permanent link")
...
## Editing diffs[¶](https://www.jj-vcs.dev/latest/config/index.html#editing-diffs "Permanent link")
...
`:builtin` is used. It launches a built-in TUI tool (known as [scm-diff-editor](https://github.com/arxanas/scm-record?tab=readme-ov-file#scm-diff-editor))
...
Meld](https://www.jj-vcs.dev/latest/config/index.html#using-meld-as-a-diff-editor).

**Suggestion:** If possible, it is recommended to try an external diff tool like
[Meld](https://www.jj-vcs.dev/latest/config/index.html#using-meld-as-a-diff-editor) (see below for some other possibilities)
...
### Experimental 3-pane diff editing[¶](https://www.jj-vcs.dev/latest/config/index.html#experimental-3-pane-diff-editing "Permanent link")
...
### `JJ-INSTRUCTIONS`[¶](https://www.jj-vcs.dev/latest/config/index.html#jj-instructions "Permanent link")
...
### Using Meld as a diff editor[¶](https://www.jj-vcs.dev/latest/config/index.html#using-meld-as-a-diff-editor "Permanent link")
...
and `meld-3` for a [three-pane view](https://www.jj-vcs.dev/latest/config/index.html#experimental-3-pane-diff-editing).

There is also a `meld` [merge tool](https://www.jj-vcs.dev/latest/config/index.html#3-way-merge-tools-for-conflict-resolution)
that can be useful, but does not support displaying the merge base while
merging.

### Using Vim as a diff editor[¶](https://www.jj-vcs.dev/latest/config/index.html#using-vim-as-a-diff-editor "Permanent link")

Using `ui.diff-editor = "vimdiff"` is possible but not recommended. For a better
experience, you can follow [instructions from the Wiki](https://github.com/jj-vcs/jj/wiki/Vim,-Neovim#using-vim-as-a-diff-tool) to configure the
[DirDiff Vim plugin](https://github.com/will133/vim-dirdiff) and/or the [vimtabdiff Python script](https://github.com/balki/vimtabdiff).

## 3-way merge tools for conflict resolution[¶](https://www.jj-vcs.dev/latest/config/index.html#3-way-merge-tools-for-conflict-resolution "Permanent link")
...
### Setting up a custom merge tool[¶](https://www.jj-vcs.dev/latest/config/index.html#setting-up-a-custom-merge-tool "Permanent link")
...
### Editing conflict markers with a tool or a text editor[¶](https://www.jj-vcs.dev/latest/config/index.html#editing-conflict-markers-with-a-tool-or-a-text-editor "Permanent link")
...
[`ui.conflict-marker-style`](https://www.jj-vcs.dev/latest/config/index.html#conflict-marker-style).

## Code formatting and other file content transformations[¶](https://www.jj-vcs.dev/latest/config/index.html#code-formatting-and-other-file-content-transformations "Permanent link")
...
### Configuration[¶](https://www.jj-vcs.dev/latest/config/index.html#configuration_1 "Permanent link")
...
### Enforce coding style rules[¶](https://www.jj-vcs.dev/latest/config/index.html#enforce-coding-style-rules "Permanent link")
...
### Sort and remove duplicate lines from a file[¶](https://www.jj-vcs.dev/latest/config/index.html#sort-and-remove-duplicate-lines-from-a-file "Permanent link")
...
### Tools stored inside the workspace[¶](https://www.jj-vcs.dev/latest/config/index.html#tools-stored-inside-the-workspace "Permanent link")
...
### Execution order of tools[¶](https://www.jj-vcs.dev/latest/config/index.html#execution-order-of-tools "Permanent link")
...
### Disabling and enabling tools[¶](https://www.jj-vcs.dev/latest/config/index.html#disabling-and-enabling-tools "Permanent link")
...
## Commit Signing[¶](https://www.jj-vcs.dev/latest/config/index.html#commit-signing "Permanent link")
...
### GnuPG Signing[¶](https://www.jj-vcs.dev/latest/config/index.html#gnupg-signing "Permanent link")
...
#### PKCS#12 Certificates[¶](https://www.jj-vcs.dev/latest/config/index.html#pkcs12-certificates "Permanent link")
...
### SSH Signing[¶](https://www.jj-vcs.dev/latest/config/index.html#ssh-signing "Permanent link")
...
### Manually signing commits[¶](https://www.jj-vcs.dev/latest/config/index.html#manually-signing-commits "Permanent link")

You can use [`jj sign`](https://www.jj-vcs.dev/latest/cli-reference/index.html#jj-sign)/[`jj unsign`](https://www.jj-vcs.dev/latest/cli-reference/index.html#jj-unsign)
...
### Automatically signing commits[¶](https://www.jj-vcs.dev/latest/config/index.html#automatically-signing-commits "Permanent link")
...
## Commit Signature Verification[¶](https://www.jj-vcs.dev/latest/config/index.html#commit-signature-verification "Permanent link")
...
`commit.signature()` (see [Commit type](https://www.jj-vcs.dev/latest/templates/index.html#commit-type)). The
returned [CryptographicSignature
Type](https://www.jj-vcs.dev/latest/templates/index.html#cryptographicsignature-type) provides methods to retrieve
signature details.

## Git settings[¶](https://www.jj-vcs.dev/latest/config/index.html#git-settings "Permanent link")

### Default colocation[¶](https://www.jj-vcs.dev/latest/config/index.html#default-colocation "Permanent link")
...
See [Colocated Jujutsu/Git workspaces](https://www.jj-vcs.dev/latest/git-compatibility/index.html#colocated-jujutsugit-repos)
for more information.

### Default remotes for `jj git fetch` and `jj git push`[¶](https://www.jj-vcs.dev/latest/config/index.html#default-remotes-for-jj-git-fetch-and-jj-git-push "Permanent link")
...
configuration](https://www.jj-vcs.dev/latest/config/index.html#config-files-and-toml) variable `git.fetch`, which can be a
...
also use other [string pattern syntax](https://www.jj-vcs.dev/latest/revsets/index.html#string-patterns):
...
### Automatic tracking of bookmarks[¶](https://www.jj-vcs.dev/latest/config/index.html#automatic-tracking-of-bookmarks "Permanent link")
...
[string pattern](https://www.jj-vcs.dev/latest/revsets/index.html#string-patterns) that matches the names of the
...
* Lastly, you may be working on various projects with different conventions for
  ...
  section ["Conditional variables"](https://www.jj-vcs.dev/latest/config/index.html#conditional-variables).

### Automatic local bookmark creation on `jj git clone`[¶](https://www.jj-vcs.dev/latest/config/index.html#automatic-local-bookmark-creation-on-jj-git-clone "Permanent link")
...
### Abandon commits that became unreachable in Git[¶](https://www.jj-vcs.dev/latest/config/index.html#abandon-commits-that-became-unreachable-in-git "Permanent link")

By default, when `jj` imports refs from Git, it will look for commits that used
to be [reachable](https://git-scm.com/docs/gitglossary/#Documentation/gitglossary.txt-aiddefreachableareachable) but no longer are reachable. Those commits will
...
### Generated bookmark names on push[¶](https://www.jj-vcs.dev/latest/config/index.html#generated-bookmark-names-on-push "Permanent link")
...
### Set of private commits[¶](https://www.jj-vcs.dev/latest/config/index.html#set-of-private-commits "Permanent link")
...
### Git subprocessing behavior[¶](https://www.jj-vcs.dev/latest/config/index.html#git-subprocessing-behavior "Permanent link")
...
## Merge settings[¶](https://www.jj-vcs.dev/latest/config/index.html#merge-settings "Permanent link")

### Granularity of hunks[¶](https://www.jj-vcs.dev/latest/config/index.html#granularity-of-hunks "Permanent link")
...
### Resolution of same-change conflicts[¶](https://www.jj-vcs.dev/latest/config/index.html#resolution-of-same-change-conflicts "Permanent link")
...
## Filesystem monitor[¶](https://www.jj-vcs.dev/latest/config/index.html#filesystem-monitor "Permanent link")
...
### Watchman[¶](https://www.jj-vcs.dev/latest/config/index.html#watchman "Permanent link")
...
## Snapshot settings[¶](https://www.jj-vcs.dev/latest/config/index.html#snapshot-settings "Permanent link")

### Paths to automatically track[¶](https://www.jj-vcs.dev/latest/config/index.html#paths-to-automatically-track "Permanent link")
...
copy. However, first [ignore](https://www.jj-vcs.dev/latest/working-copy/index.html#ignored-files) them or remove them
from the `snapshot.auto-track` patterns; otherwise they will be immediately
tracked again.

### Maximum size for new files[¶](https://www.jj-vcs.dev/latest/config/index.html#maximum-size-for-new-files "Permanent link")
...
### Automatic update of stale working copies[¶](https://www.jj-vcs.dev/latest/config/index.html#automatic-update-of-stale-working-copies "Permanent link")
...
This is particularly useful if you have [multiple workspaces](https://www.jj-vcs.dev/latest/working-copy/index.html#workspaces)
and want to avoid manually updating each one.

For more information on stale working copies, see the [working copy
documentation](https://www.jj-vcs.dev/latest/working-copy/index.html#stale-working-copy).

## Working copy settings[¶](https://www.jj-vcs.dev/latest/config/index.html#working-copy-settings "Permanent link")

### EOL conversion settings[¶](https://www.jj-vcs.dev/latest/config/index.html#eol-conversion-settings "Permanent link")

This settings serves the same purpose as the [`core.autocrlf`](https://git-scm.com/book/en/v2/Customizing-Git-Git-Configuration#_core_autocrlf) git
config.

The line endings conversion won't be applied to files detected as binary files
via a heuristics[1](https://www.jj-vcs.dev/latest/config/index.html#fn:1) regardless of the settings. This is similar to git.
...
### Respect or ignore executable bit permission changes[¶](https://www.jj-vcs.dev/latest/config/index.html#respect-or-ignore-executable-bit-permission-changes "Permanent link")
...
## Ways to specify `jj` config: details[¶](https://www.jj-vcs.dev/latest/config/index.html#ways-to-specify-jj-config-details "Permanent link")

### User config files[¶](https://www.jj-vcs.dev/latest/config/index.html#user-config-files "Permanent link")
...
with [Conditional Variables](https://www.jj-vcs.dev/latest/config/index.html#conditional-variables).
...
### JSON Schema Support[¶](https://www.jj-vcs.dev/latest/config/index.html#json-schema-support "Permanent link")
...
### Specifying config on the command-line[¶](https://www.jj-vcs.dev/latest/config/index.html#specifying-config-on-the-command-line "Permanent link")
...
### Conditional variables[¶](https://www.jj-vcs.dev/latest/config/index.html#conditional-variables "Permanent link")

You can conditionally enable config variables by using `--when`.

#### Using `[[--scope]]` tables[¶](https://www.jj-vcs.dev/latest/config/index.html#using-scope-tables "Permanent link")
...
#### Using multiple files[¶](https://www.jj-vcs.dev/latest/config/index.html#using-multiple-files "Permanent link")
...
#### Available condition keys[¶](https://www.jj-vcs.dev/latest/config/index.html#available-condition-keys "Permanent link")
...
1. To detect if a file is binary, Jujutsu currently checks if there is NULL
   ...
   doesn't plan to align the binary detection logic with git. [↩](https://www.jj-vcs.dev/latest/config/index.html#fnref:1 "Jump back to footnote 1 in the text")
