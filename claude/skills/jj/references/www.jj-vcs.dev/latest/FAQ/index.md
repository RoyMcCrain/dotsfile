---
title: "FAQ - Jujutsu docs"
source_url: "https://www.jj-vcs.dev/latest/FAQ/index"
...
* FAQ
  ...
  Table of contents
  + [Why does my bookmark not move to the new commit after jj new/commit?](https://www.jj-vcs.dev/latest/FAQ/index.html#why-does-my-bookmark-not-move-to-the-new-commit-after-jj-newcommit)
  + [I made a commit and jj git push --all says "Nothing changed" instead of pushing it. What do I do?](https://www.jj-vcs.dev/latest/FAQ/index.html#i-made-a-commit-and-jj-git-push-all-says-nothing-changed-instead-of-pushing-it-what-do-i-do)
  + [Where is my commit, why is it not visible in jj log?](https://www.jj-vcs.dev/latest/FAQ/index.html#where-is-my-commit-why-is-it-not-visible-in-jj-log)
  + [What are elided revisions in the output of jj log? How can I display them?](https://www.jj-vcs.dev/latest/FAQ/index.html#what-are-elided-revisions-in-the-output-of-jj-log-how-can-i-display-them)
  + [How can I get jj log to show me what git log would show me?](https://www.jj-vcs.dev/latest/FAQ/index.html#how-can-i-get-jj-log-to-show-me-what-git-log-would-show-me)
  + [Can I monitor how jj log evolves?](https://www.jj-vcs.dev/latest/FAQ/index.html#can-i-monitor-how-jj-log-evolves)
  + [Should I colocate my repository?](https://www.jj-vcs.dev/latest/FAQ/index.html#should-i-colocate-my-repository)
  + [jj is said to record the working copy after jj log and every other command. Where can I see these automatic "saves"?](https://www.jj-vcs.dev/latest/FAQ/index.html#jj-is-said-to-record-the-working-copy-after-jj-log-and-every-other-command-where-can-i-see-these-automatic-saves)
  + [Can I prevent Jujutsu from recording my unfinished work? I'm not ready to commit it.](https://www.jj-vcs.dev/latest/FAQ/index.html#can-i-prevent-jujutsu-from-recording-my-unfinished-work-im-not-ready-to-commit-it)
  + [Can I interactively create a new commit from only some of the changes in the working copy, like git add -p && git commit or hg commit -i?](https://www.jj-vcs.dev/latest/FAQ/index.html#can-i-interactively-create-a-new-commit-from-only-some-of-the-changes-in-the-working-copy-like-git-add-p-git-commit-or-hg-commit-i)
  + [Is there something like git rebase --interactive or hg histedit?](https://www.jj-vcs.dev/latest/FAQ/index.html#is-there-something-like-git-rebase-interactive-or-hg-histedit)
  + [How can I keep my scratch files in the repository without committing them?](https://www.jj-vcs.dev/latest/FAQ/index.html#how-can-i-keep-my-scratch-files-in-the-repository-without-committing-them)
  + [How can I avoid committing my local-only changes to tracked files?](https://www.jj-vcs.dev/latest/FAQ/index.html#how-can-i-avoid-committing-my-local-only-changes-to-tracked-files)
  + [I accidentally changed files in the wrong commit, how do I move the recent changes into another commit?](https://www.jj-vcs.dev/latest/FAQ/index.html#i-accidentally-changed-files-in-the-wrong-commit-how-do-i-move-the-recent-changes-into-another-commit)

    - [Step 1: Find the commit ID for the "last good version"](https://www.jj-vcs.dev/latest/FAQ/index.html#step-1-find-the-commit-id-for-the-last-good-version)
    - [Step 2: Create a new change on top of the original revision](https://www.jj-vcs.dev/latest/FAQ/index.html#step-2-create-a-new-change-on-top-of-the-original-revision)
    - [Step 3: Move any bookmarks to the original revision](https://www.jj-vcs.dev/latest/FAQ/index.html#step-3-move-any-bookmarks-to-the-original-revision)
    - [Step 4: Abandon the unwanted revision](https://www.jj-vcs.dev/latest/FAQ/index.html#step-4-abandon-the-unwanted-revision)
  + [How do I resume working on an existing change?](https://www.jj-vcs.dev/latest/FAQ/index.html#how-do-i-resume-working-on-an-existing-change)
  + [Why are most merge commits marked as "(empty)"?](https://www.jj-vcs.dev/latest/FAQ/index.html#why-are-most-merge-commits-marked-as-empty)
  + [How do I revert a merge commit? jj revert -r <merge> does nothing](https://www.jj-vcs.dev/latest/FAQ/index.html#how-do-i-revert-a-merge-commit-jj-revert-r-merge-does-nothing)
  + [How do I deal with divergent changes?](https://www.jj-vcs.dev/latest/FAQ/index.html#how-do-i-deal-with-divergent-changes)
  + [How do I deal with conflicted bookmarks ('??' after bookmark name)?](https://www.jj-vcs.dev/latest/FAQ/index.html#how-do-i-deal-with-conflicted-bookmarks-after-bookmark-name)
  + [I'm experiencing jj command issues in a Vite/Vitest project, how do I fix this?](https://www.jj-vcs.dev/latest/FAQ/index.html#im-experiencing-jj-command-issues-in-a-vitevitest-project-how-do-i-fix-this)
  + [I want to write a tool which integrates with Jujutsu. Should I use the library or parse the CLI?](https://www.jj-vcs.dev/latest/FAQ/index.html#i-want-to-write-a-tool-which-integrates-with-jujutsu-should-i-use-the-library-or-parse-the-cli)
  + [Why is Jujutsu a separate project? Why were the features not contributed to Git instead?](https://www.jj-vcs.dev/latest/FAQ/index.html#why-is-jujutsu-a-separate-project-why-were-the-features-not-contributed-to-git-instead)
...
# Frequently asked questions[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#frequently-asked-questions "Permanent link")

### Why does my bookmark not move to the new commit after `jj new/commit`?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#why-does-my-bookmark-not-move-to-the-new-commit-after-jj-newcommit "Permanent link")
...
### I made a commit and `jj git push --all` says "Nothing changed" instead of pushing it. What do I do?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#i-made-a-commit-and-jj-git-push-all-says-nothing-changed-instead-of-pushing-it-what-do-i-do "Permanent link")

`jj git push --all` pushes all *bookmarks*, not all revisions. You have two
options:
...
### Where is my commit, why is it not visible in `jj log`?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#where-is-my-commit-why-is-it-not-visible-in-jj-log "Permanent link")
...
in [config](https://www.jj-vcs.dev/latest/config/index.html).
...
See [revsets](https://www.jj-vcs.dev/latest/revsets/index.html) and [templates](https://www.jj-vcs.dev/latest/templates/index.html) for further guidance.

### What are elided revisions in the output of `jj log`? How can I display them?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#what-are-elided-revisions-in-the-output-of-jj-log-how-can-i-display-them "Permanent link")
...
To view the elided revisions, change the [revset expression](https://www.jj-vcs.dev/latest/revsets/index.html) so it
...
### How can I get `jj log` to show me what `git log` would show me?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#how-can-i-get-jj-log-to-show-me-what-git-log-would-show-me "Permanent link")

Use `jj log -r ..`. The `..` [operator](https://www.jj-vcs.dev/latest/revsets/index.html#operators) lists all visible commits in the repo, excluding the root (which is never interesting and is shared by all repos).

### Can I monitor how `jj log` evolves?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#can-i-monitor-how-jj-log-evolves "Permanent link")
...
### Should I colocate my repository?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#should-i-colocate-my-repository "Permanent link")
...
drawbacks](https://www.jj-vcs.dev/latest/git-compatibility/index.html#colocated-jujutsugit-repos) but the most
important ones are:
...
* If the working copy commit or its parent contain any conflicted files, tools
  ...
  conflicts](https://www.jj-vcs.dev/latest/technical/conflicts/index.html)). See
...
### `jj` is said to record the working copy after `jj log` and every other command. Where can I see these automatic "saves"?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#jj-is-said-to-record-the-working-copy-after-jj-log-and-every-other-command-where-can-i-see-these-automatic-saves "Permanent link")

Indeed, every `jj` command updates the current "working-copy" revision, marked
with `@` in `jj log`. You can notice this by how the [commit ID](https://www.jj-vcs.dev/latest/glossary/index.html#commit-id) of the
working copy revision changes when it's updated. Note that, unless you move to
another revision (with `jj new` or `jj edit`, for example), the [change ID](https://www.jj-vcs.dev/latest/glossary/index.html#change-id) will
not change.
...
### Can I prevent Jujutsu from recording my unfinished work? I'm not ready to commit it.[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#can-i-prevent-jujutsu-from-recording-my-unfinished-work-im-not-ready-to-commit-it "Permanent link")
...
If you have changes you *never* want to put in a public commit, see: [How can I
keep my scratch files in the repository without committing
them?](https://www.jj-vcs.dev/latest/FAQ/index.html#how-can-i-keep-my-scratch-files-in-the-repository-without-committing-them)

For more options see the next question.

### Can I interactively create a new commit from only some of the changes in the working copy, like `git add -p && git commit` or `hg commit -i`?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#can-i-interactively-create-a-new-commit-from-only-some-of-the-changes-in-the-working-copy-like-git-add-p-git-commit-or-hg-commit-i "Permanent link")
...
### Is there something like `git rebase --interactive` or `hg histedit`?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#is-there-something-like-git-rebase-interactive-or-hg-histedit "Permanent link")
...
There is a [tracking issue](https://github.com/jj-vcs/jj/issues/1531) you can check for updates.

To squash or split commits, use `jj squash` and `jj split`.

### How can I keep my scratch files in the repository without committing them?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#how-can-i-keep-my-scratch-files-in-the-repository-without-committing-them "Permanent link")
...
### How can I avoid committing my local-only changes to tracked files?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#how-can-i-avoid-committing-my-local-only-changes-to-tracked-files "Permanent link")
...
To avoid pushing change *wwwwwwww* by mistake, use the configuration
[git.private-commits](https://www.jj-vcs.dev/latest/config/index.html#set-of-private-commits):

```
jj config set --user git.private-commits "'''description('private:*')'''"
```

### I accidentally changed files in the wrong commit, how do I move the recent changes into another commit?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#i-accidentally-changed-files-in-the-wrong-commit-how-do-i-move-the-recent-changes-into-another-commit "Permanent link")
...
#### Step 1: Find the commit ID for the "last good version"[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#step-1-find-the-commit-id-for-the-last-good-version "Permanent link")
...
`jj` has saved](https://www.jj-vcs.dev/latest/FAQ/index.html#jj-is-said-to-record-the-working-copy-after-jj-log-and-every-other-command-where-can-i-see-these-automatic-saves) by running `jj evolog`, perhaps with the `--patch`
option. The obsolete versions will be marked as "hidden" and will have the same
change ID, but will have different commit IDs. This represents the [change](https://www.jj-vcs.dev/latest/glossary/index.html#change)
evolving over time.
...
[change offset](https://www.jj-vcs.dev/latest/glossary/index.html#change-offset) to distinguish them (e.g. `b800` can
...
#### Step 2: Create a new change on top of the original revision[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#step-2-create-a-new-change-on-top-of-the-original-revision "Permanent link")
...
and `31a347e0`), so we call these [divergent](https://www.jj-vcs.dev/latest/glossary/index.html#divergent-change). Similarly
to hidden commits, divergent commits also require a
[change offset](https://www.jj-vcs.dev/latest/glossary/index.html#change-offset) when using the change ID to refer to
...
#### Step 3: Move any bookmarks to the original revision[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#step-3-move-any-bookmarks-to-the-original-revision "Permanent link")

```
$ jj bookmark move --from 31a347e0 --to b8004ea8
```

#### Step 4: Abandon the unwanted revision[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#step-4-abandon-the-unwanted-revision "Permanent link")
...
### How do I resume working on an existing change?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#how-do-i-resume-working-on-an-existing-change "Permanent link")
...
### Why are most merge commits marked as "(empty)"?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#why-are-most-merge-commits-marked-as-empty "Permanent link")
...
### How do I revert a merge commit? `jj revert -r <merge>` does nothing[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#how-do-i-revert-a-merge-commit-jj-revert-r-merge-does-nothing "Permanent link")
...
### How do I deal with divergent changes?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#how-do-i-deal-with-divergent-changes "Permanent link")

See: [Handling divergent commits](https://www.jj-vcs.dev/latest/guides/divergence/index.html).

### How do I deal with conflicted bookmarks ('??' after bookmark name)?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#how-do-i-deal-with-conflicted-bookmarks-after-bookmark-name "Permanent link")

A [conflicted bookmark](https://www.jj-vcs.dev/latest/bookmarks/index.html#conflicts) is a bookmark that refers to multiple
...
### I'm experiencing `jj` command issues in a Vite/Vitest project, how do I fix this?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#im-experiencing-jj-command-issues-in-a-vitevitest-project-how-do-i-fix-this "Permanent link")
...
### I want to write a tool which integrates with Jujutsu. Should I use the library or parse the CLI?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#i-want-to-write-a-tool-which-integrates-with-jujutsu-should-i-use-the-library-or-parse-the-cli "Permanent link")
...
### Why is Jujutsu a separate project? Why were the features not contributed to Git instead?[¶](https://www.jj-vcs.dev/latest/FAQ/index.html#why-is-jujutsu-a-separate-project-why-were-the-features-not-contributed-to-git-instead "Permanent link")
